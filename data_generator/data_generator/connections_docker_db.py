...
# MONGO DB
# docker run -d  --name testingmongo  -p 27017:27017 -h localhost -v ~/mongodb:/db/testingmongo -e MONGO_INITDB_ROOT_USERNAME=testingmongo -e MONGO_INITDB_ROOT_PASSWORD=testingmongo mongo:latest
